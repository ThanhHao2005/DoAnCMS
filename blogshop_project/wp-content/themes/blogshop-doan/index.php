 ...
 * Đây là template dự phòng, sẽ hiển thị nếu không tìm thấy template chuyên biệt nào khác
 */
get_header(); ?>

<!-- Dán TOÀN BỘ code HTML nội dung chính còn lại của index.html vào đây -->
<!-- Bao gồm Slider, Categories, Products Section, Blog, v.v. -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product d-flex flex-column">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-1.png"
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product d-flex flex-column">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-2.png"
                            alt="Colorlib Template" />
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-3.png"
                            alt="Colorlib Template" />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-4.png"
                            alt="Colorlib Template" />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product d-flex flex-column">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-5.png"
                            alt="Colorlib Template" />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product d-flex flex-column">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-6.png"
                            alt="Colorlib Template" />
                        <span class="status">50% Off</span>
                        <div class="overlay"></div>
                    </a>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-7.png"
                            alt="Colorlib Template" />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                            src="<?php echo get_template_directory_uri(); ?>/images/product-8.png"
                            alt="Colorlib Template" />
                        <div class="overlay"></div>
                    </a>
                    <div class="text py-3 pb-4 px-3">
            ...
            <div class="col-md-6">
                ...
                <div class="text-deal">
                    ...
                    <ul class="thumb-deal d-flex mt-4">
                        <li class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/product-6.png)"></li>
                        <li class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/product-2.png)"></li>
                        <li class="img" style="background-image: url(<?php echo get_template_directory_uri(); ?>/images/product-4.png)"></li>
                    </ul>
                </div>
            </div>
        </div>
